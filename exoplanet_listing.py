...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 11 19:01:27 2025
...
for idx, row in hot_jupiters.iterrows():
    ...
    print(f" → {len(nearby)-1} komşu bulundu, olası CPM eşleşmeleri eklendi.")
...
print(f"💾 Olası bağlı adaylar '{output_file}' dosyasına kaydedildi.")
